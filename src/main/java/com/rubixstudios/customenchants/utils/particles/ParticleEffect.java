package com.rubixstudios.customenchants.utils.particles;
...
public enum ParticleEffect
{
    ...
    {
        for (Map.Entry entry : NAME_MAP.entrySet())
    ...
    {
        for (Map.Entry entry : ID_MAP.entrySet())
    ...
    public static final class ParticlePacket
    {
                ...
                throws ParticleEffect.ParticlePacket.VersionIncompatibleException
        {
            ...
            try
            {
                ...
                Class packetClass = ReflectionHandler.PackageType.MINECRAFT_SERVER.getClass(version < 7 ? "Packet63WorldParticles" : "PacketPlayOutWorldParticles");
                packetConstructor = ReflectionHandler.getConstructor(packetClass, new Class[0]);
                ...
                sendPacket = ReflectionHandler.getMethod(playerConnection.getType(), "sendPacket", new Class[] { ReflectionHandler.PackageType.MINECRAFT_SERVER.getClass("Packet") });
                ...
                throws ParticleEffect.ParticlePacket.PacketInstantiationException, ParticleEffect.ParticlePacket.PacketSendingException
        {
            if (this.packet == null)
                try {
                    ...
                    ReflectionHandler.setValue(this.packet, true, "b", Float.valueOf((float)center.getX()));
                    ReflectionHandler.setValue(this.packet, true, "c", Float.valueOf((float)center.getY()));
                    ReflectionHandler.setValue(this.packet, true, "d", Float.valueOf((float)center.getZ()));
